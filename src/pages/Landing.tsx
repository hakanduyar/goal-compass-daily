  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-zinc-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Rocket */}
        <div className="absolute top-32 left-16 animate-float text-4xl opacity-80" style={{ animationDelay: '0s' }}>
          🚀
        </div>
        {/* Chart */}
        <div className="absolute top-48 right-20 animate-float text-4xl opacity-80" style={{ animationDelay: '1s' }}>
          📊
        </div>
        {/* Document */}
        <div className="absolute bottom-32 left-20 animate-float text-4xl opacity-80" style={{ animationDelay: '2s' }}>
          📋
        </div>
        {/* Star */}
        <div className="absolute top-64 right-32 animate-float text-3xl opacity-70" style={{ animationDelay: '0.5s' }}>
          ⭐
        </div>
        {/* Target */}
        <div className="absolute bottom-48 right-16 animate-float text-3xl opacity-70" style={{ animationDelay: '1.5s' }}>
          🎯
        </div>
        {/* Trophy */}
        <div className="absolute top-96 left-32 animate-float text-3xl opacity-70" style={{ animationDelay: '2.5s' }}>
          🏆
        </div>
      </div>
      ...
      <nav className="relative z-50 px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-gray-900/95 backdrop-blur-md border-t border-gray-700 px-4 py-6">
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Button 
                onClick={() => navigate('/dashboard')}
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 text-lg rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto"
              >
                Hemen Başla
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-white/20 text-white hover:bg-white/10 px-8 py-4 text-lg rounded-full transition-all duration-300 w-full sm:w-auto"
              >
                Demo İzle
              </Button>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card 
                key={index} 
                className={`bg-white/10 backdrop-blur-sm border-white/20 transition-all duration-500 cursor-pointer group
                  ${index % 3 === 0 ? 'rotate-1 hover:rotate-0' : 
                    index % 3 === 1 ? '-rotate-1 hover:rotate-0' : 
                    'rotate-2 hover:rotate-0'} 
                  hover:bg-white/15 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 animate-slide-up`} 
